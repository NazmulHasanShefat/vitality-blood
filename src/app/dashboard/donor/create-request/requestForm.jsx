          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                >
                  <option value="" disabled className="bg-white text-gray-800 dark:bg-[#111827] dark:text-slate-100">Select Blood Group</option>
                  {bloodGroups.map((group) => (
                    <option key={group} value={group} className="bg-white text-gray-800 dark:bg-[#111827] dark:text-slate-100">{group}</option>
                  ))}
                </select>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-700 bg-white text-gray-800 dark:bg-[#1e293b] dark:text-slate-100 focus:ring-2 focus:ring-red-500/20 focus:border-[#b91c1c] outline-none transition appearance-none text-sm"
                >
                  <option value="" disabled className="bg-white text-gray-800 dark:bg-[#111827] dark:text-slate-100">Select District</option>
                  {districts.map((district) => (
                    <option key={district} value={district} className="bg-white text-gray-800 dark:bg-[#111827] dark:text-slate-100">{district}</option>
                  ))}
                </select>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                >
                  <option value="" disabled className="bg-white text-gray-800 dark:bg-[#111827] dark:text-slate-100">Select Upazila</option>
                  {selectedDistrict && upazilas[selectedDistrict]?.map((upazila) => (
                    <option key={upazila} value={upazila} className="bg-white text-gray-800 dark:bg-[#111827] dark:text-slate-100">{upazila}</option>
                  ))}
                </select>
              </div>
            </div>
